          ...
          <div className="col-12">
            <div className="card">
              <div className="card-header">
                <h3 className="card-title"><b>Projects</b></h3>
              ...
              <div className="card-body table-responsive p-0" style={{height: "300px"}}>
                <table className="table table-head-fixed text-nowrap">
                  ...
                  {projectData.map((data)=>{
                    ...
                    const startDate = (new Date(data.get("startDate"))).toLocaleDateString('en-US', DATE_OPTIONS);
                    const endDate = (new Date(data.get("endDate"))).toLocaleDateString('en-US', DATE_OPTIONS);
                    ...
                    <tr>
                      ...
                      <td><span className="tag tag-success">{data.get("status")}</span></td>
