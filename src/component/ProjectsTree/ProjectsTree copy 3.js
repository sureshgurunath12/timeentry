...
export default class ProjectsTree extends Component {
        ...
        <form className="node_edit_form">
          <div className="field name">
            <input
              ...
              placeholder="Option"
              onChange={(e) => {
                this.handleEditChange(e, value);
              }}
            />
          </div>
          <div className="field code">
            <input
              value={value.exportValue}
              type="text"
              name="exportValue"
              placeholder="Value"
              onChange={(e) => {
          ...
          <div className="field action_node">
            ...
            <span
              ...
              onClick={(e) => {
                this.closeForm(value, parent, index);
              }}
            ></span>
          </div>
        </form>
    ...
    children = node.map((value, index) => {
      ...
      if (value.children.length > 0 && value.showChildren) {
        ...
        item = (
          ...
          >
            {value.editMode
              ? this.nodeEditForm(value, node, index)
              : normalMode}
            {babies}
          </li>
        );
      ...
      <span className="root">
        ...
        <span className="actions">
          ...
          <i
            ...
            onClick={(e) => {
              e.stopPropagation();
              this.makeEditable(this.state.data);
            }}
          >
            {" "}
            edit{" "}
    ...
    return (
      <div className="row">
        <div className="col-md-offset-4 col-md-3">
          <div className="group_dropdown_content">{this.getNodes()}</div>
        </div>
      </div>
    );
  }
